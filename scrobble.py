...
class _Network(object):
    ...
    def __init__(self, name, homepage, ws_server, api_key, api_secret, session_key, submission_server, username, password_hash,
        ...
        """
            ...
            password_hash: the output of md5(password) where password is the user's password
...
class LastFMNetwork(_Network):
    ...
    def __repr__(self):
        return "LastFMNetwork(%s)" %(", ".join(("'%s'" %self.api_key, "'%s'" %self.api_secret, "'%s'" %self.session_key, 
...
class LibreFMNetwork(_Network):
    ...
    def __repr__(self):
        return "LibreFMNetwork(%s)" %(", ".join(("'%s'" %self.api_key, "'%s'" %self.api_secret, "'%s'" %self.session_key, 
            "'%s'" %self.username, "'%s'" %self.password_hash)))
...
class SessionKeyGenerator(object):
    ...
    2) Username and Password Authentication:
        ...
        c. password_hash = md5(raw_input("Please enter your password: ")
...
class Album(_BaseObject, _Taggable):
    ...
    def __repr__(self):
        return "Album(%s, %s, %s)" %(repr(self.artist.name), repr(self.title), repr(self.network))
...
class Artist(_BaseObject, _Taggable):
    ...
    def __repr__(self):
        return "Artist(%s, %s)" %(repr(self.get_name()), repr(self.network))
...
class Event(_BaseObject):
    ...
    def __repr__(self):
        return "Event(%s, %s)" %(repr(self.id), repr(self.network))
...
class Country(_BaseObject):
    ...
    def __repr__(self):
        return "Country(%s, %s)" %(repr(self.name), repr(self.network))
...
class Library(_BaseObject):
    ...
    def __repr__(self):
        return "Library(%s, %s)" %(repr(self.user), repr(self.network))
...
class Tag(_BaseObject):
    ...
    def __repr__(self):
        return "Tag(%s, %s)" %(repr(self.name), repr(self.network))
...
class Track(_BaseObject, _Taggable):
    ...
    def __repr__(self):
        return "Track(%s, %s, %s)" %(repr(self.artist.name), repr(self.title), repr(self.network))
...
class Group(_BaseObject):
    ...
    def __repr__(self):
        return "Group(%s, %s)" %(repr(self.name), repr(self.network))
...
class User(_BaseObject):
    ...
    def __repr__(self):
        return "User(%s, %s)" %(repr(self.name), repr(self.network))
...
class Venue(_BaseObject):
    ...
    def __repr__(self):
        return "Venue(%s, %s)" %(repr(self.id), repr(self.network))
...
network = LastFMNetwork(api_key = API_KEY, api_secret = API_SECRET, username = USERNAME, password_hash = md5(PASSWORD))
